...
namespace DataSync.Service.VTiger
{
    public class VTigerService
    {
        ...
        internal string VTigerExecuteOperation(string operation, string parameters, bool post)
        {
            return VTigerExecuteOperation(VTigerUrl, operation, parameters, post);
        }

        internal string VTigerExecuteOperation(string vTigerUrl, string operation, string parameters, bool post)
        {
            string response;
            if (post)
